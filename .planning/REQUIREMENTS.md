...
- [x] **PLAN-03**: L'utente può creare/rigenerare il piano per la settimana successiva mentre è ancora attivo il piano corrente
- [x] **PLAN-04**: L'utente può rigenerare il piano fornendo feedback testuale ("meno pesce questa settimana", "più piatti veloci")
- [x] **PLAN-05**: Il piano segnala esplicitamente i pasti che riutilizzano avanzi del giorno precedente
- [x] **PLAN-06**: L'utente può scambiare un singolo pasto con un'alternativa suggerita compatibile con il profilo
